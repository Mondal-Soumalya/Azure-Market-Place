...
const AnalysisEnginePage = () => {
  ...
  const features = [
    {
      icon: <Speed sx={{ fontSize: 40, color: '#00ffdc' }} />,
      title: 'Eliminate',
      description: 'Identify and remove unnecessary steps and redundant processes'
    },
    {
      icon: <AutoFixHigh sx={{ fontSize: 40, color: '#00e68f' }} />,
      title: 'Standardize',
      description: 'Create consistent procedures and unified approaches'
    },
    {
      icon: <Psychology sx={{ fontSize: 40, color: '#5f7fff' }} />,
      title: 'Optimize',
      description: 'Enhance efficiency and improve resource utilization'
    },
    {
      icon: <Refresh sx={{ fontSize: 40, color: '#ffa800' }} />,
      title: 'Automate',
      description: 'Implement automated solutions for repetitive tasks'
    }
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formDataObj.append('incident_file', formData.incident_file);
      ...
      const response = await fetch('/api/incidentanalysis', {
        method: 'POST',
        body: formDataObj
      });
        ...
        >
          ...
          <Box sx={{ textAlign: 'center', mb: 6 }}>
            ...
            >
              ...
              >
                E.S.O.A.R Analysis Engine
              </Typography>
              <Typography
                variant="h6"
                sx={{ color: 'rgba(255, 255, 255, 0.7)', maxWidth: 600, mx: 'auto' }}
              >
                Upload your incident ticket dump to analyze ESOAR opportunities—Eliminate, Standardize, Optimize, Automate, and Robotize.
              </Typography>
            </motion.div>
          </Box>
          ...
          >
            <StyledPaper>
              <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                <Analytics sx={{ fontSize: 28, color: '#00ffdc', mr: 2 }} />
                  ...
                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                    <Box sx={{ 
                      ...
                      <Typography variant="caption" sx={{ color: 'rgba(255, 255, 255, 0.7)', lineHeight: 1.6 }}>
                        ✓ Upload incident ticket dumps<br/>
                        ✓ Analyze automation opportunities<br/>
                        ✓ Identify optimization areas<br/>
          ...
          {analysisResults && (
            ...
            >
              <StyledPaper sx={{ mt: 4 }}>
                {/* Results Header */}
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 4, pb: 2, borderBottom: '1px solid rgba(102, 255, 224, 0.2)' }}>
                  <Box sx={{ 
                    background: 'linear-gradient(135deg, #66FFE0 0%, #10b981 100%)',
                    borderRadius: '8px',
                    p: 1.5
                  }}>
                    <Analytics sx={{ fontSize: 24, color: '#0f172a' }} />
                  </Box>
                  <Box>
                    ...
                    <Typography variant="caption" sx={{ color: 'rgba(255, 255, 255, 0.6)' }}>
                      ML-Powered Incident Analysis Report
                    </Typography>
                  </Box>
                </Box>
                ...
                <Box sx={{ display: 'block', mb: 2 }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 1 }}>
                    <Box sx={{
                      ...
                      <Analytics sx={{ fontSize: 22, color: '#0f172a' }} />
                    </Box>
                    <Typography variant="h6" sx={{ fontWeight: 700, color: '#fff' }}>Analysis Result</Typography>
                  </Box>
...
export default AnalysisEnginePage;
